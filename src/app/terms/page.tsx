...
export const metadata = {
  ...
  description: "Terms and conditions for using the Summon Translator platform.",
}
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <p>
              Summon Translator provides AI-powered translation services. Users can upload content files,
              select target languages, and receive translated output in the original file format.
              The Service supports JSON, XLIFF, Markdown, PDF, and other common file formats.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">6. Your content and data retention</h2>
            <p>
              You retain all rights to the content you upload (&quot;Your Content&quot;). By using the Service,
              you grant Summon Translator a limited license to process Your Content solely to provide
              the Service. You represent that you have the right to upload and translate Your Content.
            </p>
            <p className="mt-3">
              Your Content is not used to train AI models. Translation job data (uploaded files and
              translated output) is <strong>automatically and permanently deleted 48 hours after job completion</strong>.
              You are responsible for downloading your translated files before this window expires.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The Summon Translator platform, including its software, design, and brand, is owned by
              Summon Translator and protected by intellectual property law. You may not copy, modify,
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, Summon Translator shall not be liable for any
              indirect, incidental, special, consequential, or punitive damages, or any loss of profits
              or revenues, arising out of your use of the Service. Our total liability for any claim
              arising out of or relating to these Terms shall not exceed the amount you paid us in the
